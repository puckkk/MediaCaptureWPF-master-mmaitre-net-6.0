...
{
    cout << "InternalSetCurrentMediaType" << endl;
    auto lock = _lock.LockExclusive();
...
{
    cout << "_IsMediaTypeSupported" << endl;
    GUID majorType;
    GUID subType;
